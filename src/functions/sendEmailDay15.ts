...
export const emailDay_15_html = ({ factura }: sendEmailDay_15Props) => {
  const html = `
  <div style="width:100%;">
  ...
  <div style="font-family: 'Open Sans',sans-serif; margin:0 auto; ">
    <div style="width:600px;border-radius:10px;background:#ffffff; padding-bottom:32px; background:#f6f6f7; margin:10px auto;">
        <div
        ...
        <div style="padding:40px; font-family: 'Open Sans',sans-serif; padding-top:0px;">
            <div style="margin-top:40px;margin-bottom:32px;width: 512px;margin: 20px auto;  ">
                ...
                <span style="margin:20px 0px;color:#222;">${
                    factura.cliente
...
export const sendEmailDay_15 = async ({ factura }: sendEmailDay_15Props) => {
