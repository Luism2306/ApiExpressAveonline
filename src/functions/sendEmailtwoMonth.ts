    ...
    <div style="width:600px; background:#f6f6f7;border-radius:10px; margin:auto;">
        ...
        <div style="padding:40px; font-family: 'Open Sans',sans-serif;">
            <div style="margin-top:40px;margin-bottom:32px;width: 512px;margin: 20px auto;">
                ...
                <span style="margin:20px 0px;color:#222;">Aveonline te informa que ante el incumplimiento de pago de su
                    factura ${factura.factura} con más de 60 días en mora, su caso se encuentra en trámite de cobro
                    juridico. Para conocer sobre el estado del trámite póngase en contacto . Si tienes alguna duda contactanos Aveonline .</span>
                <div style="
                    margin-top: 40px;
                    margin-bottom: 32px;
