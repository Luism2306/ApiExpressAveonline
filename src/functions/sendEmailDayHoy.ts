...
<div style="font-family: 'Open Sans',sans-serif; margin:0 auto; justify-content: center !important; width:600px;border-radius:10px;padding-bottom:32px; background:#f6f6f7; border-style: solid; border-width: 1px 1px 1px 1px; border-color: #EBEBEB;
  box-shadow: 0px 2px 10px 0px rgb(0 0 0 / 6%);  margin: 20px auto;">
    <div style="width:600px; background:#f6f6f7;border-radius:10px; margin:auto;">
        <div
            style="padding-left:0!important;height:12px;background:linear-gradient(296.48deg,#ac24f1 46.11%,#ff585d 97.89%);border-radius:10px 10px 0px 0px ; width:600px; margin:auto;">
        </div>
        <div style="padding:40px; font-family: 'Open Sans',sans-serif;">
            <div style="margin-top:40px;margin-bottom:32px;width: 512px;margin: 20px auto;">
                ...
                <span style="margin:20px 0px;color:#222;">Recuerda que hoy vence el pago de tu factura ${
                    ...
                    )} para que lo realices oportunamente.Si ya pagaste o tienes dineros pendientes por reembolsar de
                    los dineros recaudados haz caso omiso. Aveonline. Si tienes alguna duda, <a
                        src="https://web.whatsapp.com/send?phone=573233162889&text=Hola%2C%20estaba%20en%20https%3A%2F%2Faveonline.co%20me%20gustar%C3%ADa%20recibir%20m%C3%A1s%20informaci%C3%B3n.">contactanos</a></span>
                <div style="
                  margin-top: 40px;
                  margin-bottom: 32px;
